...
<table id="external-resource-table-3" class="table table-striped">
    ...
    <tr>
        <td class="text-center"><a rel="./card-audit.md">Calypso Card Analyzer</a></td>
...
{{% /modal %}}
    ...
    <tr>
        <td class="text-center"><a rel="./basic-sam.md">Calypso Basic Legacy SAM Personalizer</a></td>
        <td class="text-center">Windows, Linux, macOS</td>
        <td class="text-center">Java/Kotlin</td>
...
{{% /modal %}}
    ...
    <tr>
        <td class="text-center"><a rel="./basic-card.md">Calypso Basic Card Personalizer</a></td>
        <td class="text-center">Windows, Linux, macOS</td>
        <td class="text-center">Java/Kotlin</td>
        <td class="text-center">CNA Member</td>
        <td class="text-center">Reserved</td>
